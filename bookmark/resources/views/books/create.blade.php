...
<form method='POST' action='/books'>
    ...
    <input type='text' dusk='title-input' name='title' id='title' value='{{ old("title") }}'>
    ...
    <input type='text' dusk='slug-input' name='slug' id='slug' value='{{ old("slug") }}'>
    ...
    <input type='text' dusk='published-year-input' name='published_year' id='published_year' value='{{ old("published_year") }}'>
    @include('includes/error-field', ['fieldName' => 'published_year'])

    <label for='cover_url'>Cover URL</label>
    <input type='text' dusk='cover-url-input' name='cover_url' id='cover_url' value='{{ old("cover_url", "http://") }}'>
    @include('includes/error-field', ['fieldName' => 'cover_url'])

    <label for='info_url'>* Wikipedia URL</label>
    <input type='text' dusk='info-url-input' name='info_url' id='info_url' value='{{ old("info_url", "http://") }}'>
    @include('includes/error-field', ['fieldName' => 'info_url'])

    <label for='purchase_url'>* Purchase URL </label>
    <input type='text' dusk='purchase-url-input' name='purchase_url' id='purchase_url' value='{{ old("purchase_url", "http://") }}'>
    @include('includes/error-field', ['fieldName' => 'purchase_url'])

    <label for='description'>Description</label>
    <textarea name='description' dusk='description-textarea'>{{ old('description') }}</textarea>
    @include('includes/error-field', ['fieldName' => 'description'])

    <button type='submit' dusk='add-book-button' class='btn btn-primary'>Add Book</button>
